        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="footer4-text16">Education</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="footer4-text18">Work Experience</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="footer4-text15">Language Skills</span>
                </Fragment>
              )}
            </a>
            <a
...
Footer4.defaultProps = {
  ...
  link2: undefined,
  link4: undefined,
  logoAlt: 'Nishan Shashintha Portfolio',
