            ...
            {props.content1 ?? (
              <Fragment>
                <span className="pricing14-text178">
                  ...
                  Nullam auctor, nisl at ultricies ultrices, libero turpis
                  vehicula purus, nec interdum metus urna nec nunc.
                </span>
              </Fragment>
            )}
          </span>
              ...
              {props.content2 ?? (
                <Fragment>
                  <span className="pricing14-text202">
                    Sed euismod, justo et lacinia malesuada, nisi libero
                    ultricies justo, vel tincidunt turpis purus vel libero.
                  </span>
                </Fragment>
              )}
            </p>
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text199">$100</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text168">$200</span>
                      </Fragment>
                    )}
                  </p>
                </div>
              ...
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text194">$300</span>
                      </Fragment>
                    )}
                  </p>
                </div>
            ...
            <div className="pricing14-column4 thq-card">
              <div className="pricing14-price16">
                <div className="pricing14-price17">
                  ...
                  <h3 className="pricing14-text132 thq-heading-3">
                    {props.plan1Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text173">$15</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan1Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text192">$150</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <button className="pricing14-button17 thq-button-outline thq-button-animated">
                <span className="thq-body-small">
                  {props.plan1Action1 ?? (
                    <Fragment>
                      <span className="pricing14-text169">Upgrade Plan</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column5 thq-card">
              <div className="pricing14-price18">
                <div className="pricing14-price19">
                  ...
                  <h3 className="pricing14-text139 thq-heading-3">
                    {props.plan2Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text193">$25</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan2Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text187">$250</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <button className="pricing14-button18 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan2Action1 ?? (
                    <Fragment>
                      <span className="pricing14-text176">Upgrade Plan</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column6 thq-card">
              <div className="pricing14-price20">
                <div className="pricing14-price21">
                  ...
                  <h3 className="pricing14-text147 thq-heading-3">
                    {props.plan3Price1 ?? (
                      <Fragment>
                        <span className="pricing14-text196">$35</span>
                      </Fragment>
                    )}
                  </h3>
                  <span className="thq-body-large">
                    {props.plan3Yearly1 ?? (
                      <Fragment>
                        <span className="pricing14-text189">$350</span>
                      </Fragment>
                    )}
                  </span>
                </div>
              ...
              <button className="pricing14-button19 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action1 ?? (
                    <Fragment>
                      <span className="pricing14-text203">Upgrade Plan</span>
                    </Fragment>
                  )}
                </span>
              </button>
