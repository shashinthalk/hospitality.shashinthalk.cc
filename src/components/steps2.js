          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Worked as a Front Desk Receptionist at Hotel Sacher,
                      providing exceptional customer service and ensuring guest
                      satisfaction.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Served as a Guest Relations Officer at Hotel am
                      Mirabellplatz, handling guest inquiries, resolving issues,
                      and enhancing overall guest experience.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Education</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Graduated with a degree in ICT from a university in Sri
                      Lanka, equipped with technical skills and knowledge in the
                      field.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Language Skills</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Fluent in English and Sinhala, with proficiency in
                      communication and writing in both languages.
                    </span>
                  </Fragment>
                )}
              </span>
